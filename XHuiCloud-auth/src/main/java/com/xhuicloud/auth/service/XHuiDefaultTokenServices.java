...
/**
 * @program: XHuiCloud
 * @description: 重写实现 一个设备登陆
 * @author: Sinda
 * @create: 2020/9/29 2:25 下午
 */
public class XHuiDefaultTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
