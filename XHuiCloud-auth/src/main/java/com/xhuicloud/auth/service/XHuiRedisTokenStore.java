 ...
 * @description:
 * @author: Sinda
 * @create: 2020/9/28 4:22 下午
 */
public class XHuiRedisTokenStore implements TokenStore {

    private static final String ACCESS = "access:";

    private static final String AUTH_TO_ACCESS = "auth:to:access:";

    private static final String AUTH = "auth:";

    private static final String REFRESH_AUTH = "refresh:auth:";

    private static final String ACCESS_TO_REFRESH = "access:to:refresh:";

    private static final String REFRESH = "refresh:";

    private static final String REFRESH_TO_ACCESS = "refresh:to:access:";

    private static final String CLIENT_ID_TO_ACCESS = "client:id:to:access:";

    private static final String UNAME_TO_ACCESS = "uname:to:access:";
    ...
    public XHuiRedisTokenStore(RedisConnectionFactory connectionFactory) {
    ...
    private byte[] serializeKey(String object) {
        return serialize(XHuiTenantHolder.getTenant() + prefix + object);
    }
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        ...
        try {
            ...
            // KEY
            byte[] key = serializeKey(String.format("%s%s", "token:", authentication.getName()));
            // value
            byte[] tokenVal = serialize(token.getValue());
            RedisStringCommands stringCommand = conn.stringCommands();
    ...
    public void removeAccessToken(String tokenValue) {
        ...
        try {
            ...
            if (authentication != null) {
                ...
                // keyName
                byte[] keyName = serializeKey(
                        String.format("%s%s", "token:", authentication.getName()));
                // 获取redis连接
                conn.del(keyName);
                conn.closePipeline();
            }
