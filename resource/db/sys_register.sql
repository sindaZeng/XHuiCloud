...
) ENGINE=InnoDB AUTO_INCREMENT=213 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='config_info';
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
BEGIN;
INSERT INTO `his_config_info` VALUES (200, 105, 'application-common.yml', 'DEFAULT_GROUP', '', 'spring:\n  cloud:\n    circuitbreaker:\n      sentinel:\n        enabled: true\n    sentinel:\n      filter:\n        urlPatterns:\n          - /**\n      transport:\n        # sentinel 地址\n        dashboard: localhost:14000\n        #监控此服务端口\n        port: ${server.port}\n    nacos:\n      discovery:\n        #nacos 地址\n        server-addr: ${nacos.address}\n  main:\n    allow-bean-definition-overriding: true\n\nseata:\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${nacos.address}\n  config:\n    type: nacos\n    nacos:\n      server-addr: ${nacos.address}\n  tx-service-group: fdp_tx_group\n  service:\n    disable-global-transaction: false\n    \nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\nfeign:\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n  sentinel:\n    #feign开启sentinle监控\n    enabled: true\n    \nmybatis-plus:\n  global-config:\n    banner: false\n    db-config:\n      logic-delete-field: delFlag  #全局逻辑删除字段值 3.3.0开始支持，详情看下面。\n      logic-delete-value: 0 # 逻辑已删除值(默认为 1)\n      logic-not-delete-value: 1 # 逻辑未删除值(默认为 0)\n\n  zipkin:\n    #设置zipkin的地址\n    base-url: http://localhost:9411/\n    #注意 如果不设置 nacos客户端会把这个当成服务名疯狂的从服务端获取此服务\n    discoveryClientEnabled: false\n  sleuth:\n    sampler:\n      #抽样率 默认是(10%) 生产环境请不要设置1.0\n      probability: 1.0\n\nlogging:\n  file:\n    path: /Users/cengxinda/workspace/sourceCode/FDPlatform/logs\n    name: ${logging.file.path}/${spring.application.name}/root.log\n\nsecurity:\n  oauth2:\n    client:\n      #access-token-uri: http://localhost:15000/FDP-auth/oauth/token  #请求令牌的地址\n      #user-authorization-uri: http://localhost:15000/FDP-auth/oauth/authorize #对用户授权的地址\n      ignore-urls:\n        - /druid/**\n        - /v2/api-docs\n    resource:\n      loadBalanced: true\n      token-info-uri: http://FDP-gateway:15000/auth/oauth/check_token #检查token是否有效的地址\nswagger:\n  title: FDP快速开发平台\n  description: 快速开发平台\n  license: Powered By Sinda\n  license-url: http://www.zsinda.cn/\n  terms-of-service-url: http://www.zsinda.cn/\n  version: 1.0.0\n  contact:\n    name: Sinda\n    email: sindazeng@gmail.com\n    url: https://github.com/sindaZeng', '3a67b8c4da816002b5ec8bddfaff040f', '2010-05-05 00:00:00', '2020-03-18 11:10:25', NULL, '127.0.0.1', 'U', '');
INSERT INTO `his_config_info` VALUES (200, 106, 'application-common.yml', 'DEFAULT_GROUP', '', 'spring:\n  cloud:\n    circuitbreaker:\n      sentinel:\n        enabled: true\n    sentinel:\n      filter:\n        urlPatterns:\n          - /**\n      transport:\n        # sentinel 地址\n        dashboard: localhost:14000\n        #监控此服务端口\n        port: ${server.port}\n    nacos:\n      discovery:\n        #nacos 地址\n        server-addr: ${nacos.address}\n  main:\n    allow-bean-definition-overriding: true\n\nseata:\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${nacos.address}\n  config:\n    type: nacos\n    nacos:\n      server-addr: ${nacos.address}\n  tx-service-group: fdp_tx_group\n  service:\n    disable-global-transaction: false\n    \nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\nfeign:\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n  sentinel:\n    #feign开启sentinle监控\n    enabled: true\n    \nmybatis-plus:\n  global-config:\n    banner: false\n    db-config:\n      logic-delete-field: delFlag  #全局逻辑删除字段值 3.3.0开始支持，详情看下面。\n      logic-delete-value: 0 # 逻辑已删除值(默认为 1)\n      logic-not-delete-value: 1 # 逻辑未删除值(默认为 0)\n\n  zipkin:\n    #设置zipkin的地址\n    base-url: http://localhost:9411/\n    #注意 如果不设置 nacos客户端会把这个当成服务名疯狂的从服务端获取此服务\n    discoveryClientEnabled: false\n  sleuth:\n    sampler:\n      #抽样率 默认是(10%) 生产环境请不要设置1.0\n      probability: 1.0\n\nlogging:\n  file:\n    path: /Users/cengxinda/workspace/sourceCode/FDPlatform/logs/A\n    # name: ${logging.file.path}/${spring.application.name}/root.log\n\nsecurity:\n  oauth2:\n    client:\n      #access-token-uri: http://localhost:15000/FDP-auth/oauth/token  #请求令牌的地址\n      #user-authorization-uri: http://localhost:15000/FDP-auth/oauth/authorize #对用户授权的地址\n      ignore-urls:\n        - /druid/**\n        - /v2/api-docs\n    resource:\n      loadBalanced: true\n      token-info-uri: http://FDP-gateway:15000/auth/oauth/check_token #检查token是否有效的地址\nswagger:\n  title: FDP快速开发平台\n  description: 快速开发平台\n  license: Powered By Sinda\n  license-url: http://www.zsinda.cn/\n  terms-of-service-url: http://www.zsinda.cn/\n  version: 1.0.0\n  contact:\n    name: Sinda\n    email: sindazeng@gmail.com\n    url: https://github.com/sindaZeng', 'f9fde935b1dc673e2d95ae6c5d0e3a93', '2010-05-05 00:00:00', '2020-03-18 11:37:56', NULL, '127.0.0.1', 'U', '');
INSERT INTO `his_config_info` VALUES (200, 107, 'application-common.yml', 'DEFAULT_GROUP', '', 'spring:\n  cloud:\n    circuitbreaker:\n      sentinel:\n        enabled: true\n    sentinel:\n      filter:\n        urlPatterns:\n          - /**\n      transport:\n        # sentinel 地址\n        dashboard: localhost:14000\n        #监控此服务端口\n        port: ${server.port}\n    nacos:\n      discovery:\n        #nacos 地址\n        server-addr: ${nacos.address}\n  main:\n    allow-bean-definition-overriding: true\n\nseata:\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${nacos.address}\n  config:\n    type: nacos\n    nacos:\n      server-addr: ${nacos.address}\n  tx-service-group: fdp_tx_group\n  service:\n    disable-global-transaction: false\n    \nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\nfeign:\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n  sentinel:\n    #feign开启sentinle监控\n    enabled: true\n    \nmybatis-plus:\n  global-config:\n    banner: false\n    db-config:\n      logic-delete-field: delFlag  #全局逻辑删除字段值 3.3.0开始支持，详情看下面。\n      logic-delete-value: 0 # 逻辑已删除值(默认为 1)\n      logic-not-delete-value: 1 # 逻辑未删除值(默认为 0)\n\n  zipkin:\n    #设置zipkin的地址\n    base-url: http://localhost:9411/\n    #注意 如果不设置 nacos客户端会把这个当成服务名疯狂的从服务端获取此服务\n    discoveryClientEnabled: false\n  sleuth:\n    sampler:\n      #抽样率 默认是(10%) 生产环境请不要设置1.0\n      probability: 1.0\n\nlogging:\n  file:\n    path: /Users/cengxinda/workspace/sourceCode/FDPlatform/logs\n    # name: ${logging.file.path}/${spring.application.name}/root.log\n\nsecurity:\n  oauth2:\n    client:\n      #access-token-uri: http://localhost:15000/FDP-auth/oauth/token  #请求令牌的地址\n      #user-authorization-uri: http://localhost:15000/FDP-auth/oauth/authorize #对用户授权的地址\n      ignore-urls:\n        - /druid/**\n        - /v2/api-docs\n    resource:\n      loadBalanced: true\n      token-info-uri: http://FDP-gateway:15000/auth/oauth/check_token #检查token是否有效的地址\nswagger:\n  title: FDP快速开发平台\n  description: 快速开发平台\n  license: Powered By Sinda\n  license-url: http://www.zsinda.cn/\n  terms-of-service-url: http://www.zsinda.cn/\n  version: 1.0.0\n  contact:\n    name: Sinda\n    email: sindazeng@gmail.com\n    url: https://github.com/sindaZeng', '944774cf9bf1bcf8691dfff8eba66db0', '2010-05-05 00:00:00', '2020-03-18 12:42:08', NULL, '127.0.0.1', 'U', '');
