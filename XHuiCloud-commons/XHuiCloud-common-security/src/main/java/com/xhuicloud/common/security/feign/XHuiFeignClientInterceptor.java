 ...
 */
@Slf4j
public class XHuiFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public XHuiFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext
